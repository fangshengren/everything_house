...
public class InterceptorConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(customJwtInterceptor())
                ...
                .excludePathPatterns("/user/sendEmail/**","/user/checkChangePassword","/user/sendForgetPasswordEmail/**",
                        "/user/login","/user/loginByEmail","/user/register","/role","/role/page","/**/export","/**/import","/file/**","/news/**", "/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**", "/api", "/api-docs", "/api-docs/**")
